...
{{< cards >}}
  ...
  icon="map"
  >}}
  {{< card link="/side-projects/picoviz/" 
...
If you'd prefer to go to the direct HTML pages (faster loading), follow these links here:
- [Thesis Project](/thesis/index.html)
- [bevmap](/bevmap/index.html)
- [PicoViz](https://sukritsingh.github.io/picoviz/examples)
